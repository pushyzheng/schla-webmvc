package com.jobless.webmvc.autoconfig;

import com.jobless.webmvc.exception.BaseException;
import com.jobless.webmvc.util.ResourceUtil;
...
public class PropertiesConfigReader {
    ...
    private static final String PROPERTIES_FILENAME = "jobless-webmvc.properties";
